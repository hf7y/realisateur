...
#
# Zach-directed, 2026-08-04: "install scheduler to a root, system wide
# location ... then other users don't need to look inside ecosim. Later, when
...
# 0700 home (MONKEY.md section 2), and each of those users carried its own
...
SEED_KEY="${SCHEDULER_SEED_KEY:-/home/ecosim/.ssh/deploy_scheduler}"
