...
echo "  3. A LIVE row whose OLDEST-OPEN is weeks old is a PACING question."
echo "     There is no reweight answer any more: bin/weight-audit.sh and"
echo "     bin/incubation-audit.sh were retired 2026-08-07 because the weight"
echo "     column allocates nothing on the only dispatching host. Cadence is"
echo "     measured now, not configured -- bin/thermostat-wiring.sh."
