...
# realisateur#267 moved it under bin/retired/. groc-mangr#3 recorded the same
# shape a week earlier and it was fixed by hand, per host, which is why it came
# straight back. F2 is the half that matters most: a prune that could delete a
# file this installer did not write would be a worse defect than the orphan.
