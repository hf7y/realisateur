...
bin/retired/README.md              realisateur the retirement ledger: what is unwired, when, why, and which issue records the ideas worth rebuilding. Naming what it retires is a row of this repo's own checklist, so the ledger is realisateur's.
