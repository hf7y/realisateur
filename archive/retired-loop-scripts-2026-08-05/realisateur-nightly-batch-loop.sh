...
# execs the generic entrypoint; all real config is in schedule/realisateur.conf.
exec "/home/zach/Documents/Projects/scheduler/bin/scheduler-run" realisateur batch
