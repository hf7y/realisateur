...
- [ ] Pull request body follows the grammar `gh-sign` enforces at write time
      (refuses a noncompliant body) — canonical source is
      **`bin/lib/body-grammar.sh`**. Reference it; do NOT paraphrase it into
      a brief.
